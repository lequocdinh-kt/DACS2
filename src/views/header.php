...
<header class="main-header">
    <div class="header-container">
        ...
        <nav class="header-nav">
            <ul class="nav-menu">
                <li><a href="index.php?page=schedule" class="<?php echo (isset($_GET['page']) && $_GET['page'] === 'schedule') ? 'active' : ''; ?>">LỊCH CHIẾU</a></li>
                <li><a href="index.php?page=movies" class="<?php echo (isset($_GET['page']) && $_GET['page'] === 'movies') ? 'active' : ''; ?>">PHIM</a></li>
